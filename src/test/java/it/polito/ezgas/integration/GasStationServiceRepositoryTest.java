...
@DataJpaTest
public class GasStationServiceRepositoryTest {
	...
	public void testGetAllGasStations() {
		...
		// Test Non-Empty List
		GasStation gs = new GasStation ("Torino 1", "Via Vigone 3", true, false, true, false, true, 
				false, "Enjoy", 45.066667, 7.666667, 1.41, 0.0, 1.56, 0.0, 0.89, 0.0, -1, null, 0);
		entityManager.persist(gs);
		
		GasStation gs1 = new GasStation ("Torino 2", "Via Vigone 33", true, false, true, false, true,
				false, "Car2Go", 45.066667, 7.666667, 1.41, 0.0, 1.56, 0.0, 0.89, 0.0, -1, null, 0);
	...
	public void testDeleteGasStation() throws InvalidGasStationException {
		 ...
		 GasStation gs = new GasStation ("Torino 1", "Via Vigone 3", true, false, true, false, true, 
				 false, "Enjoy", 45.066667, 7.666667, 1.41, 0.0, 1.56, 0.0, 0.89, 0.0, null, null, 0);
		 entityManager.persist(gs);
	...
	public void testGetGasStationsByGasolineType() throws InvalidGasTypeException {
		...
		GasStation gs = new GasStation ("Torino 1", "Via Vigone 3", true, true, true, true, true, 
				true, "Enjoy", 45.066667, 7.666667, 1.41, 1.51, 1.61, 0.79, 0.89, 0.99, null, null, 0);
		entityManager.persist(gs);
	...
	public void testGetGasStationsByProximity() throws GPSDataException {
		...
		GasStation gs = new GasStation ("Torino 1", "Via Vigone 3", true, true, true, true, true, true, 
				"Enjoy", 45.066667, 7.666667, 1.41, 1.51, 1.61, 0.79, 0.89, 0.99, null, null, 0);
		entityManager.persist(gs);
	...
	public void testGetGasStationByCarSharing() {
		...
		GasStation gs1 = new GasStation ("Torino 2", "Via Vigone 33", true, true, true, true, true, true, 
				"Car2Go", 45.066667, 7.666667, 1.41, 0.0, 1.56, 0.0, 0.89, 0.0, null, null, 0);
		entityManager.persist(gs1);
	...
	public void getGasStationsWithoutCoordinates() throws InvalidGasTypeException, InvalidCarSharingException {
		...
		GasStation gs = new GasStation ("Torino 1", "Via Vigone 3", true, true, true, true, true, true, 
				"Enjoy", 45.066667, 7.666667, 1.31, 1.46, 1.56, 0.79, 0.89, 0.99, null, null, 0);
		entityManager.persist(gs);
		
		GasStation gs1 = new GasStation ("Torino 2", "Via Vigone 33", true, true, true, true, true, true, 
				"Car2Go", 47.066667, 9.666667, 1.31, 1.46, 1.56, 0.79, 0.89, 0.99, null, null, 0);
		entityManager.persist(gs1);
	...
	public void testSetReport() throws InvalidGasStationException, PriceException, InvalidUserException {
		...
		User u2 = new User("User2", "password1", "email@2.it", 0);
		...
		service.setReport(100, 1.41, 1.51, 1.61, 0.81, 0.91, 0.99, u2Id);
		assertNull(gs.getReportTimestamp());
		
		// Test UserId non present in the DB
		service.setReport(gsId, 1.41, 1.51, 1.61, 0.81, 0.91, 0.99, 100);
		assertNull(gs.getUser());
		
		User u1 = new User("User1", "password1", "email@1.it", 1);
		entityManager.persist(u1);
		Integer u1Id = u1.getUserId();
		...
		gs.setReportUser(u1Id);
		gs.setUser(u1);
		
		// Test Set Report with DateDiff <= 4 days and U2 reputation < U1 reputation
		service.setReport(gsId, 1.41, 1.51, 1.61, 0.81, 0.91, 1.1, u2Id);
		
		assertTrue(gs.getReportUser() == u1Id && gs.getUser() == u1);
	
		// Test Set Report with DateDiff <= 4 days and U2 reputation >= U1 reputation
		u2.setReputation(2);
		service = new GasStationServiceimpl(gsConverter, gsRepository, uRepository);
		service.setReport(gsId, 1.41, 1.51, 1.61, 0.81, 0.91, 0.99, u2Id);

		assertTrue(gs.getGasStationId() == gsId
				&& gs.getDieselPrice() == 1.41
				&& gs.getSuperPrice() == 1.51
				&& gs.getSuperPlusPrice() == 1.61
				&& gs.getGasPrice() == 0.81
				&& gs.getMethanePrice() == 0.91
				&& gs.getPremiumDieselPrice() == 0.99
				&& gs.getReportUser() == u2Id
				&& gs.getUser() == u2
		...
		// Test Negative GasStationId
		assertThrows(InvalidGasStationException.class, ()-> { service.setReport(-1, 1.41, 1.51, 1.61, 0.81, 0.91, 0.99, u2Id); });

		// Test Negative UserId
		assertThrows(InvalidUserException.class, ()-> { service.setReport(gsId, 1.41, 1.51, 1.61, 0.81, 0.91, 0.99, -1); });

		// Test Negative DieselPrice 
		gs.setHasDiesel(true);
		assertThrows(PriceException.class, ()-> { service.setReport(gsId, -1.41, 1.51, 1.61, 0.81, 0.91, 0.99, u2Id); });
	...
	public void testGetGasStationsWithCoordinates() throws InvalidGasTypeException, GPSDataException, InvalidCarSharingException {
		...
		GasStation gs = new GasStation("Torino 1", "Via Vigone 3", true, true, true, true , true, true, 
				"null", 45.066667, 7.666667, 1.41, 0.342, 1.56, 0.234, 0.89, 1.01, null, null, 0);
		entityManager.persist(gs);
		...
		GasStation gsCS1 = new GasStation("Torino 2", "Via Vigone 4", true, true, true, true , true, true, 
				"Enjoy", 45.066667, 7.666667, 1.41, 0.342, 1.56, 0.234, 0.89, 0.99, null, null, 0);
		entityManager.persist(gsCS1);
		GasStation gsCS2 = new GasStation("Torino 3", "Via Vigone 5", true, true, true, true , true, true, 
				"Car2Go", 45.066667, 7.666667, 1.41, 0.342, 1.56, 0.234, 0.89, 0.99, null, null, 0);
