...
public class UserServiceRepositoryTest {
	...
	public void testGetUserById() throws InvalidUserException {
		...
		when(converter.convertToEntity(any(UserDto.class))).thenReturn(u);
	...
	public void testSaveUser() {
		...
		// Test to update data
		 ...
		 when(converter.convertToDto(any(User.class))).thenReturn(uDto2);
		 when(converter.convertToEntity(any(UserDto.class))).thenReturn(u2);
		 service = new UserServiceimpl(repository, converter);
		 UserDto uDtotmp = service.saveUser(uDto2);
		 assertTrue(u2.getUserId() == uDtotmp.getUserId() && u2.getPassword() != uDtotmp.getPassword());
		 ...
		 when(converter.convertToDto(any(User.class))).thenReturn(uDto3);
		 when(converter.convertToEntity(any(UserDto.class))).thenReturn(u3);
		 service = new UserServiceimpl(repository, converter);
